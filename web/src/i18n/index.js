...
const ZH = {
  ...
  tokenPrompt: "此实例需要访问令牌（ACCESS_TOKEN）：",
  tokenInvalid: "访问令牌无效。请重新输入，或取消以停止重试：",
  tokenExpired: "访问已过期。请重新输入，或取消以停止重试：",
  pipeline: {
...
const EN = {
  ...
  status: { ok: "OK", error: "Error", disabled: "Off", pending: "Pending", partial: "Partial" },
  tokenPrompt: "This instance requires an access token (ACCESS_TOKEN):",
  tokenInvalid: "Access token rejected. Enter again, or Cancel to stop retrying:",
  tokenExpired: "Session expired. Enter ACCESS_TOKEN, or Cancel to stop retrying:",
  pipeline: {
