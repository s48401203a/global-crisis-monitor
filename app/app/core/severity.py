...
def compute_severity(ev: NormalizedEvent) -> float:
    ...
    if ev.type == "wildfire":
        if v is None:
            return 0.2
        if ev.magnitude_unit == "MW":
            # FIRMS 火点簇：辐射功率 FRP 合计（MW）。约 <50 小火、50–300 中、300–1000 大、1000+ 极大
            return _band(v, [(0, 50, 0.15, 0.30), (50, 300, 0.30, 0.50),
                              (300, 1000, 0.50, 0.72), (1000, 5000, 0.72, 0.90),
                              (5000, 1e6, 0.90, 1.00)])
